...
class MainViewController: NSViewController, NSOutlineViewDataSource, NSOutlineViewDelegate {
    ...
    fileprivate var modeItems = [
        ModeItem(title: "8x8 Fixed Top-Down", converter: FixedConverter(height: 8, width: 8, direction: .topDown)),
        ModeItem(title: "8x8 Fixed Left-Right", converter: FixedConverter(height: 8, width: 8, direction: .topDown)),
        ModeItem(title: "12x7 Fixed Top-Down", converter: FixedConverter(height: 12, width: 7, direction: .topDown)),
        ModeItem(title: "12x7 Fixed Left-Right", converter: FixedConverter(height: 12, width: 7, direction: .leftRight)),
        ModeItem(title: "16x10 Fixed Top-Down", converter: FixedConverter(height: 16, width: 10, direction: .topDown)),
        ModeItem(title: "16x10 Fixed Left-Right", converter: FixedConverter(height: 16, width: 10, direction: .leftRight)),
        ModeItem(title: "16x11 Fixed Top-Down", converter: FixedConverter(height: 16, width: 11, direction: .topDown)),
        ModeItem(title: "16x11 Fixed Left-Right", converter: FixedConverter(height: 16, width: 11, direction: .leftRight))
    ]
